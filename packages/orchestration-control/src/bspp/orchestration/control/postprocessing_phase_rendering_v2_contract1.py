...
"""Frozen renderer contract 1 for postprocessing V2 authorities."""
...
def render_postprocessing_action_script_v2_contract1(
    authority: PostprocessingRenderInput,
    action: PostprocessingRuntimeAction,
) -> str:
    """Render the exact original V2 renderer-contract-1 bytes."""
