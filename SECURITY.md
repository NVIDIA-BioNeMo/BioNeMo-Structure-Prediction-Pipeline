...
2. Type of vulnerability (code execution, denial of service, buffer overflow,
   etc.)
3. Instructions to reproduce the vulnerability
4. Proof-of-concept or exploit code
5. Potential impact of the vulnerability, including how an attacker could
   exploit the vulnerability

You may also use GitHub's **private vulnerability reporting** on this repository
(Security tab → _Report a vulnerability_) as an additional channel; PSIRT
remains the fastest path to triage and tracking.

Refer to [NVIDIA Security][nvidia-security] for past NVIDIA Security Bulletins
and Notices.
